[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/xDyOva-K)
## Правила и регламент
...
Если не работает тестирование на Playwright, то выполните команду `npx playwright install chromium`
...
Скриншот тестирование выполняется для операционной системы Linux и не работает с WSL, поэтому смотрите на результат тестов в экшенах.
